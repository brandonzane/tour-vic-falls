...
const UserMenu: React.FC<UserMenuProps> = ({ currentUser }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute rounded-xl shadow-md w-[30vw] m:w-3/4 bg-white overflow-hidden right-0 top-12 text-sm">
          <div className="flex flex-col cursor-pointer">
            {currentUser ? (
              <>
                ...
                <MenuItem onClick={loginModal.onOpen} label="My listings" />
                <MenuItem
                  onClick={loginModal.onOpen}
                  label="Tour Vic Falls my home"
                />
                <hr />
